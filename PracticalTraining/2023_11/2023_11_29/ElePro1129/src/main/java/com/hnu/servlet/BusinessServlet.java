...
//        System.out.println(requestURI);
        ...
        if ("add".equals(what)){
            ...
            Business business =
                    new Business(null,businessAccount,"111111",
                            businessName,businessAddress,businessExplain,
                            Double.parseDouble(starPrice),Double.parseDouble(deliveryPrice),
                            "business");
