...
CREATE TABLE `brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分类品牌';
...
INSERT INTO `brand` VALUES ('9', '荣事达1', 'http://127.0.0.1:9000/go-mall/20231229/ad8e11d9d02d4f2ca46104cbe44fb39d荣事达.jpg', '2023-12-29 02:55:13', '2023-12-29 02:55:23', '1');
INSERT INTO `brand` VALUES ('10', '巧夫人', 'http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg', '2023-12-31 04:35:37', '2023-12-31 04:56:14', '1');
INSERT INTO `brand` VALUES ('11', '南极人', 'http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg', '2023-12-31 04:36:02', '2023-12-31 04:36:02', '0');
INSERT INTO `brand` VALUES ('12', '完美日记', 'http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg', '2023-12-31 04:36:21', '2023-12-31 04:36:21', '0');
INSERT INTO `brand` VALUES ('15', '公牛', 'http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg', '2023-12-31 04:45:43', '2023-12-31 04:45:43', '0');
INSERT INTO `brand` VALUES ('16', '荣事达1', 'http://127.0.0.1:9000/go-mall/20240103/dda60958178e4d94a03328e126291f98巧夫人.jpg', '2023-12-31 05:47:34', '2023-12-31 05:48:03', '1');
INSERT INTO `brand` VALUES ('17', 'b', null, '2024-01-04 15:21:53', '2024-01-04 15:22:09', '1');
INSERT INTO `brand` VALUES ('18', '2112', null, '2024-01-04 17:23:57', '2024-01-04 17:24:22', '1');
INSERT INTO `brand` VALUES ('19', '回力', 'http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg', '2024-01-04 17:24:41', '2024-01-04 17:24:58', '0');
INSERT INTO `brand` VALUES ('20', '农夫山泉', 'http://127.0.0.1:9000/go-mall/20240108/cd78fe7109094ede9ff04e6a6ba37dba1.jpg', '2024-01-04 22:00:51', '2024-01-04 22:00:51', '0');
...
CREATE TABLE `category_brand` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分类品牌';
...
INSERT INTO `category_brand` VALUES ('8', '6', '474', '2023-12-28 06:22:23', '2023-12-29 02:56:07', '0');
...
INSERT INTO `category_brand` VALUES ('11', '6', '474', '2023-12-29 02:55:37', '2023-12-29 02:56:02', '1');
INSERT INTO `category_brand` VALUES ('12', '11', '207', '2023-12-31 05:02:03', '2023-12-31 05:02:03', '0');
INSERT INTO `category_brand` VALUES ('13', '5', '288', '2023-12-31 05:06:58', '2023-12-31 05:06:58', '0');
INSERT INTO `category_brand` VALUES ('14', '12', '435', '2023-12-31 05:10:24', '2023-12-31 05:10:24', '0');
INSERT INTO `category_brand` VALUES ('15', '1', '123', '2023-12-31 05:20:00', '2023-12-31 05:20:00', '0');
INSERT INTO `category_brand` VALUES ('16', '11', '267', '2023-12-31 05:48:54', '2023-12-31 05:49:12', '1');
INSERT INTO `category_brand` VALUES ('17', '12', '435', '2024-01-04 15:23:20', '2024-01-04 17:25:44', '1');
INSERT INTO `category_brand` VALUES ('18', '19', '272', '2024-01-04 17:25:23', '2024-01-04 19:30:46', '0');
INSERT INTO `category_brand` VALUES ('19', '20', '353', '2024-01-04 22:02:07', '2024-01-04 22:02:07', '0');
...
CREATE TABLE `order_info` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=240 DEFAULT CHARSET=utf8mb3 COMMENT='订单';
...
INSERT INTO `order_info` VALUES ('210', '34', 'lee', '1704203405866', null, '5998.00', '0.00', '5998.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 00:25:04', '2023-12-31 00:25:04', '0');
INSERT INTO `order_info` VALUES ('211', '34', 'lee', '1704203831789', null, '5998.00', '0.00', '5998.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 00:32:45', '2023-12-31 00:32:45', '0');
INSERT INTO `order_info` VALUES ('212', '34', 'lee', '1704242174434', null, '1999.00', '0.00', '1999.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 01:17:02', '2023-12-31 01:17:02', '0');
INSERT INTO `order_info` VALUES ('213', '34', 'lee', '1704243260394', null, '2999.00', '0.00', '2999.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 01:36:38', '2023-12-31 01:36:38', '0');
INSERT INTO `order_info` VALUES ('214', '34', 'lee', '1704264836296', null, '2300.00', '0.00', '2300.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 04:25:49', '2023-12-31 04:25:49', '0');
INSERT INTO `order_info` VALUES ('215', '34', 'lee', '1704265298443', null, '4299.00', '0.00', '4299.00', '0.00', '2', '0', '晴天', '15014526352', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 04:34:10', '2023-12-31 04:34:10', '0');
INSERT INTO `order_info` VALUES ('216', '34', 'lee', '1704348541797', null, '3999.00', '0.00', '3999.00', '0.00', '2', '0', 'Lee', '15937346839', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 12:35:52', '2023-12-31 12:35:52', '0');
INSERT INTO `order_info` VALUES ('217', '34', 'lee', '1704350838619', null, '7599.00', '0.00', '7599.00', '0.00', '2', '0', 'Lee', '15937346839', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 12:57:19', '2023-12-31 12:57:19', '0');
INSERT INTO `order_info` VALUES ('218', '34', 'lee', '1704351085610', null, '499.00', '0.00', '499.00', '0.00', '2', '0', 'Lee', '15937346839', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 13:01:47', '2023-12-31 13:01:47', '0');
INSERT INTO `order_info` VALUES ('219', '1', 'test', '1704352912536', null, '1999.00', '0.00', '1999.00', '0.00', '2', '0', '张三', '15012563333', '公司', '130000', '130700', '130724', '河北省张家口市沽源县快乐家园1号', null, null, null, null, null, null, '2023-12-31 13:34:46', '2023-12-31 13:34:46', '0');
INSERT INTO `order_info` VALUES ('220', '34', 'lee', '1704353598099', null, '7599.00', '0.00', '7599.00', '0.00', '2', '2', 'Lee', '15937346839', '家', '110000', '110100', '110114', '北京市北京市昌平区天通苑大街1号', null, null, null, null, null, null, '2023-12-31 13:47:09', '2024-01-04 15:01:59', '0');
INSERT INTO `order_info` VALUES ('221', '34', 'lee', '1704438855678', null, '499.00', '0.00', '499.00', '0.00', '2', '1', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:11:25', '2024-01-04 15:02:53', '0');
INSERT INTO `order_info` VALUES ('222', '34', 'lee', '1704439331219', null, '499.00', '0.00', '499.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:20:00', '2024-01-04 14:20:00', '0');
INSERT INTO `order_info` VALUES ('223', '34', 'lee', '1704440544059', null, '499.00', '0.00', '499.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:41:54', '2024-01-04 14:41:54', '0');
INSERT INTO `order_info` VALUES ('224', '34', 'lee', '1704440998830', null, '129.00', '0.00', '129.00', '0.00', '2', '1', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:50:07', '2024-01-04 15:03:00', '0');
INSERT INTO `order_info` VALUES ('225', '34', 'lee', '1704441151035', null, '129.00', '0.00', '129.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:52:52', '2024-01-04 14:52:52', '0');
INSERT INTO `order_info` VALUES ('226', '34', 'lee', '1704441288469', null, '129.00', '0.00', '129.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 14:55:21', '2024-01-04 14:55:21', '0');
INSERT INTO `order_info` VALUES ('227', '34', 'lee', '1704455326201', null, '499.00', '0.00', '499.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 16:24:01', '2024-01-04 16:24:01', '0');
INSERT INTO `order_info` VALUES ('228', '34', 'lee', '1704455568580', null, '499.00', '0.00', '499.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 16:28:23', '2024-01-04 16:28:23', '0');
INSERT INTO `order_info` VALUES ('229', '34', 'lee', '1704455728827', null, '299.00', '0.00', '299.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 16:31:17', '2024-01-04 16:31:17', '0');
INSERT INTO `order_info` VALUES ('230', '34', 'lee', '1704456194547', null, '299.00', '0.00', '299.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 16:39:42', '2024-01-04 16:39:42', '0');
INSERT INTO `order_info` VALUES ('231', '34', 'lee', '1704456984045', null, '129.00', '0.00', '129.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 16:53:57', '2024-01-04 16:53:57', '0');
INSERT INTO `order_info` VALUES ('232', '34', 'lee', '1704457891970', null, '129.00', '0.00', '129.00', '0.00', '2', '0', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 17:10:20', '2024-01-04 17:10:20', '0');
INSERT INTO `order_info` VALUES ('233', '34', 'lee', '1704458022892', null, '35.00', '0.00', '35.00', '0.00', '2', '1', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-05 12:34:20', null, null, null, null, null, '2024-01-04 17:12:42', '2024-01-04 17:13:22', '0');
INSERT INTO `order_info` VALUES ('234', '36', 'kris', '1704459256160', null, '6999.00', '0.00', '6999.00', '0.00', '2', '1', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-05 12:54:32', null, null, null, null, null, '2024-01-04 17:34:58', '2024-01-04 17:35:16', '0');
INSERT INTO `order_info` VALUES ('235', '36', 'kris', '1704616807114', null, '109.00', '0.00', '109.00', '0.00', '2', '0', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', null, null, null, null, null, null, '2024-01-04 18:18:04', '2024-01-04 18:18:04', '0');
INSERT INTO `order_info` VALUES ('236', '36', 'kris', '1704616920452', null, '99.00', '0.00', '99.00', '0.00', '2', '1', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-07 08:42:28', null, null, null, null, null, '2024-01-04 18:20:07', '2024-01-04 18:20:36', '0');
INSERT INTO `order_info` VALUES ('237', '36', 'kris', '1704681971929', null, '129.00', '0.00', '129.00', '0.00', '2', '1', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-08 02:46:33', null, null, null, null, null, '2024-01-04 21:40:56', '2024-01-04 21:41:19', '0');
INSERT INTO `order_info` VALUES ('238', '36', 'kris', '1704682851119', null, '10826.00', '0.00', '10826.00', '0.00', '2', '1', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-08 03:01:04', null, null, null, null, null, '2024-01-04 21:56:48', '2024-01-04 21:57:03', '0');
INSERT INTO `order_info` VALUES ('239', '36', 'kris', '1704685978894', null, '16992.00', '0.00', '16992.00', '0.00', '2', '1', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南省新乡市红旗区', '2024-01-08 04:01:53', null, null, null, null, null, '2024-01-04 22:53:17', '2024-01-04 23:02:55', '0');
...
CREATE TABLE `order_item` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=486 DEFAULT CHARSET=utf8mb3 COMMENT='订单项信息';
...
INSERT INTO `order_item` VALUES ('446', '211', '6', '小米 红米Note10 5G手机 颜色:黑色 内存:18G', 'http://139.198.127.41:9000/spzx/20230525/665832167-1_u_1.jpg', '2999.00', '1', '2023-12-31 00:32:45', '2023-12-31 00:32:45', '0');
INSERT INTO `order_item` VALUES ('447', '211', '2', '小米 红米Note10 5G手机 颜色:白色 内存:18G', 'http://139.198.127.41:9000/spzx/20230525/665832167-5_u_1 (1).jpg', '2999.00', '1', '2023-12-31 00:32:45', '2023-12-31 00:32:45', '0');
INSERT INTO `order_item` VALUES ('448', '212', '5', '小米 红米Note10 5G手机 颜色:黑色 内存:8G', 'http://139.198.127.41:9000/spzx/20230525/665832167-1_u_1.jpg', '1999.00', '1', '2023-12-31 01:17:02', '2023-12-31 01:17:02', '0');
INSERT INTO `order_item` VALUES ('449', '213', '4', '小米 红米Note10 5G手机 颜色:红色 内存:18G', 'http://139.198.127.41:9000/spzx/20230525/665832167-3_u_1.jpg', '2999.00', '1', '2023-12-31 01:36:38', '2023-12-31 01:36:38', '0');
INSERT INTO `order_item` VALUES ('450', '214', '10', '华为手机最新款200 + 60L', 'http://127.0.0.1:9000/go-mall/20231229/fd26a7c4b9f24131a4f17a9465518fcc1.jpg', '2300.00', '1', '2023-12-31 04:25:49', '2023-12-31 04:25:49', '0');
INSERT INTO `order_item` VALUES ('451', '215', '5', '小米 红米Note10 5G手机 颜色:黑色 内存:8G', 'http://139.198.127.41:9000/spzx/20230525/665832167-1_u_1.jpg', '1999.00', '1', '2023-12-31 04:34:10', '2023-12-31 04:34:10', '0');
INSERT INTO `order_item` VALUES ('452', '215', '10', '华为手机最新款200 + 60L', 'http://127.0.0.1:9000/go-mall/20231229/fd26a7c4b9f24131a4f17a9465518fcc1.jpg', '2300.00', '1', '2023-12-31 04:34:10', '2023-12-31 04:34:10', '0');
INSERT INTO `order_item` VALUES ('453', '216', '25', '冰箱200 + 60L', null, '3999.00', '1', '2023-12-31 12:35:53', '2023-12-31 12:35:53', '0');
INSERT INTO `order_item` VALUES ('454', '217', '29', '华为Mate70暗夜紫 + 512G', 'http://127.0.0.1:9000/go-mall/20240104/6e045adff50f4582a23541b64838bbd02.jpg', '7599.00', '1', '2023-12-31 12:57:19', '2023-12-31 12:57:19', '0');
INSERT INTO `order_item` VALUES ('455', '218', '26', '面霜迷你套装', 'http://127.0.0.1:9000/go-mall/20240104/b6e7cad626a44d20b0c8d54b9180d7ef1-3.jpg', '499.00', '1', '2023-12-31 13:01:47', '2023-12-31 13:01:47', '0');
INSERT INTO `order_item` VALUES ('456', '219', '1', '小米 红米Note10 5G手机 颜色:白色 内存:8G', 'http://139.198.127.41:9000/spzx/20230525/665832167-5_u_1 (1).jpg', '1999.00', '1', '2023-12-31 13:34:46', '2023-12-31 13:34:46', '0');
INSERT INTO `order_item` VALUES ('457', '220', '31', '华为Mate70骑士黑 + 512G', 'http://127.0.0.1:9000/go-mall/20240104/6528cd4f2ff84f229f005f611798c2c13.jpg', '7599.00', '1', '2023-12-31 13:47:09', '2023-12-31 13:47:09', '0');
INSERT INTO `order_item` VALUES ('458', '221', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 14:11:25', '2024-01-04 14:11:25', '0');
INSERT INTO `order_item` VALUES ('459', '222', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 14:20:00', '2024-01-04 14:20:00', '0');
INSERT INTO `order_item` VALUES ('460', '223', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 14:41:54', '2024-01-04 14:41:54', '0');
INSERT INTO `order_item` VALUES ('461', '224', '20', '牛仔裤蓝色 + 均码', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '1', '2024-01-04 14:50:07', '2024-01-04 14:50:07', '0');
INSERT INTO `order_item` VALUES ('462', '225', '20', '牛仔裤蓝色 + 均码', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '1', '2024-01-04 14:52:52', '2024-01-04 14:52:52', '0');
INSERT INTO `order_item` VALUES ('463', '226', '20', '牛仔裤蓝色 + 均码', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '1', '2024-01-04 14:55:21', '2024-01-04 14:55:21', '0');
INSERT INTO `order_item` VALUES ('464', '227', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 16:24:01', '2024-01-04 16:24:01', '0');
INSERT INTO `order_item` VALUES ('465', '228', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 16:28:23', '2024-01-04 16:28:23', '0');
INSERT INTO `order_item` VALUES ('466', '229', '23', '面霜迷你套装', 'http://127.0.0.1:9000/go-mall/20240104/8949d98523244e19867df87b7d8cbb703-1.jpg', '299.00', '1', '2024-01-04 16:31:17', '2024-01-04 16:31:17', '0');
INSERT INTO `order_item` VALUES ('467', '230', '23', '面霜迷你套装', 'http://127.0.0.1:9000/go-mall/20240104/8949d98523244e19867df87b7d8cbb703-1.jpg', '299.00', '1', '2024-01-04 16:39:42', '2024-01-04 16:39:42', '0');
INSERT INTO `order_item` VALUES ('468', '231', '20', '牛仔裤蓝色 + 均码', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '1', '2024-01-04 16:53:57', '2024-01-04 16:53:57', '0');
INSERT INTO `order_item` VALUES ('469', '232', '20', '牛仔裤蓝色 + 均码', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '1', '2024-01-04 17:10:20', '2024-01-04 17:10:20', '0');
INSERT INTO `order_item` VALUES ('470', '233', '21', '帽子棕', 'http://127.0.0.1:9000/go-mall/20240104/91978beab0dc4469b0d04d555b5214054-1.jpg', '35.00', '1', '2024-01-04 17:12:42', '2024-01-04 17:12:42', '0');
INSERT INTO `order_item` VALUES ('471', '234', '28', '华为Mate70暗夜紫 + 256G', 'http://127.0.0.1:9000/go-mall/20240104/bdfc7a5ddbe84cc2903c30e21819cc4c1.jpg', '6999.00', '1', '2024-01-04 17:34:58', '2024-01-04 17:34:58', '0');
INSERT INTO `order_item` VALUES ('472', '235', '15', '外套L + 黑色', 'http://127.0.0.1:9000/go-mall/20240104/b435e2bd97c5492e9c0fc2de9c5ca2802-1.jpg', '109.00', '1', '2024-01-04 18:18:04', '2024-01-04 18:18:04', '0');
INSERT INTO `order_item` VALUES ('473', '236', '13', '外套S + 黑色', 'http://127.0.0.1:9000/go-mall/20240104/7027f542320a422fac77e3f9015bfb3b2-2.jpg', '99.00', '1', '2024-01-04 18:20:07', '2024-01-04 18:20:07', '0');
INSERT INTO `order_item` VALUES ('474', '237', '34', '一双鞋40 + 白', 'http://127.0.0.1:9000/go-mall/20240108/e9ab12d9594346cc9b4ad4114b7896432.jpg', '129.00', '1', '2024-01-04 21:40:56', '2024-01-04 21:40:56', '0');
INSERT INTO `order_item` VALUES ('475', '238', '6', '小米 红米Note10 5G手机 颜色:黑色 内存:18G', 'http://139.198.127.41:9000/spzx/20230525/665832167-1_u_1.jpg', '2999.00', '1', '2024-01-04 21:56:48', '2024-01-04 21:56:48', '0');
INSERT INTO `order_item` VALUES ('476', '238', '31', '华为Mate70骑士黑 + 512G', 'http://127.0.0.1:9000/go-mall/20240104/6528cd4f2ff84f229f005f611798c2c13.jpg', '7599.00', '1', '2024-01-04 21:56:48', '2024-01-04 21:56:48', '0');
INSERT INTO `order_item` VALUES ('477', '238', '13', '外套S + 黑色', 'http://127.0.0.1:9000/go-mall/20240104/7027f542320a422fac77e3f9015bfb3b2-2.jpg', '99.00', '1', '2024-01-04 21:56:48', '2024-01-04 21:56:48', '0');
INSERT INTO `order_item` VALUES ('478', '238', '35', '一双鞋40 + 棕', 'http://127.0.0.1:9000/go-mall/20240108/50b0b67c07a94b1ba3ef72b150841ea06.jpg', '129.00', '1', '2024-01-04 21:56:48', '2024-01-04 21:56:48', '0');
INSERT INTO `order_item` VALUES ('479', '239', '34', '一双鞋40 + 白', 'http://127.0.0.1:9000/go-mall/20240108/e9ab12d9594346cc9b4ad4114b7896432.jpg', '129.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('480', '239', '13', '外套S + 黑色', 'http://127.0.0.1:9000/go-mall/20240104/7027f542320a422fac77e3f9015bfb3b2-2.jpg', '99.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('481', '239', '33', '素颜霜超量套装', 'http://127.0.0.1:9000/go-mall/20240105/40d260ed52e349c6a2f5b853e2c018de2-4.jpg', '109.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('482', '239', '32', '素颜霜迷你套装', 'http://127.0.0.1:9000/go-mall/20240105/693f7d3df4fb456b993e5139a5cb99c02-1.jpg', '59.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('483', '239', '31', '华为Mate70骑士黑 + 512G', 'http://127.0.0.1:9000/go-mall/20240104/6528cd4f2ff84f229f005f611798c2c13.jpg', '7599.00', '2', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('484', '239', '27', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/b1d0b4ec52c4465788927103d903f9da1-1.jpg', '899.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_item` VALUES ('485', '239', '24', '面霜超量套装', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '1', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
...
CREATE TABLE `order_log` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=252 DEFAULT CHARSET=utf8mb3 COMMENT='订单操作日志记录';
...
INSERT INTO `order_log` VALUES ('217', '211', null, '0', '提交订单', '2023-12-31 00:32:45', '2023-12-31 00:32:45', '0');
INSERT INTO `order_log` VALUES ('218', '212', null, '0', '提交订单', '2023-12-31 01:17:02', '2023-12-31 01:17:02', '0');
INSERT INTO `order_log` VALUES ('219', '213', null, '0', '提交订单', '2023-12-31 01:36:38', '2023-12-31 01:36:38', '0');
INSERT INTO `order_log` VALUES ('220', '214', null, '0', '提交订单', '2023-12-31 04:25:49', '2023-12-31 04:25:49', '0');
INSERT INTO `order_log` VALUES ('221', '215', null, '0', '提交订单', '2023-12-31 04:34:10', '2023-12-31 04:34:10', '0');
INSERT INTO `order_log` VALUES ('222', '216', null, '0', '提交订单', '2023-12-31 12:35:53', '2023-12-31 12:35:53', '0');
INSERT INTO `order_log` VALUES ('223', '217', null, '0', '提交订单', '2023-12-31 12:57:19', '2023-12-31 12:57:19', '0');
INSERT INTO `order_log` VALUES ('224', '218', null, '0', '提交订单', '2023-12-31 13:01:47', '2023-12-31 13:01:47', '0');
INSERT INTO `order_log` VALUES ('225', '219', null, '0', '提交订单', '2023-12-31 13:34:46', '2023-12-31 13:34:46', '0');
INSERT INTO `order_log` VALUES ('226', '220', null, '0', '提交订单', '2023-12-31 13:47:09', '2023-12-31 13:47:09', '0');
INSERT INTO `order_log` VALUES ('227', '221', null, '0', '提交订单', '2024-01-04 14:11:25', '2024-01-04 14:11:25', '0');
INSERT INTO `order_log` VALUES ('228', '222', null, '0', '提交订单', '2024-01-04 14:20:00', '2024-01-04 14:20:00', '0');
INSERT INTO `order_log` VALUES ('229', '223', null, '0', '提交订单', '2024-01-04 14:41:54', '2024-01-04 14:41:54', '0');
INSERT INTO `order_log` VALUES ('230', '224', null, '0', '提交订单', '2024-01-04 14:50:07', '2024-01-04 14:50:07', '0');
INSERT INTO `order_log` VALUES ('231', '225', null, '0', '提交订单', '2024-01-04 14:52:52', '2024-01-04 14:52:52', '0');
INSERT INTO `order_log` VALUES ('232', '226', null, '0', '提交订单', '2024-01-04 14:55:21', '2024-01-04 14:55:21', '0');
INSERT INTO `order_log` VALUES ('233', '227', null, '0', '提交订单', '2024-01-04 16:24:01', '2024-01-04 16:24:01', '0');
INSERT INTO `order_log` VALUES ('234', '228', null, '0', '提交订单', '2024-01-04 16:28:23', '2024-01-04 16:28:23', '0');
INSERT INTO `order_log` VALUES ('235', '229', null, '0', '提交订单', '2024-01-04 16:31:17', '2024-01-04 16:31:17', '0');
INSERT INTO `order_log` VALUES ('236', '230', null, '0', '提交订单', '2024-01-04 16:39:42', '2024-01-04 16:39:42', '0');
INSERT INTO `order_log` VALUES ('237', '231', null, '0', '提交订单', '2024-01-04 16:53:57', '2024-01-04 16:53:57', '0');
INSERT INTO `order_log` VALUES ('238', '232', null, '0', '提交订单', '2024-01-04 17:10:20', '2024-01-04 17:10:20', '0');
INSERT INTO `order_log` VALUES ('239', '233', null, '0', '提交订单', '2024-01-04 17:12:42', '2024-01-04 17:12:42', '0');
INSERT INTO `order_log` VALUES ('240', '233', null, '1', '支付宝支付成功', '2024-01-04 17:13:22', '2024-01-04 17:13:22', '0');
INSERT INTO `order_log` VALUES ('241', '234', null, '0', '提交订单', '2024-01-04 17:34:58', '2024-01-04 17:34:58', '0');
INSERT INTO `order_log` VALUES ('242', '234', null, '1', '支付宝支付成功', '2024-01-04 17:35:16', '2024-01-04 17:35:16', '0');
INSERT INTO `order_log` VALUES ('243', '235', null, '0', '提交订单', '2024-01-04 18:18:04', '2024-01-04 18:18:04', '0');
INSERT INTO `order_log` VALUES ('244', '236', null, '0', '提交订单', '2024-01-04 18:20:07', '2024-01-04 18:20:07', '0');
INSERT INTO `order_log` VALUES ('245', '236', null, '1', '支付宝支付成功', '2024-01-04 18:20:36', '2024-01-04 18:20:36', '0');
INSERT INTO `order_log` VALUES ('246', '237', null, '0', '提交订单', '2024-01-04 21:40:56', '2024-01-04 21:40:56', '0');
INSERT INTO `order_log` VALUES ('247', '237', null, '1', '支付宝支付成功', '2024-01-04 21:41:19', '2024-01-04 21:41:19', '0');
INSERT INTO `order_log` VALUES ('248', '238', null, '0', '提交订单', '2024-01-04 21:56:48', '2024-01-04 21:56:48', '0');
INSERT INTO `order_log` VALUES ('249', '238', null, '1', '支付宝支付成功', '2024-01-04 21:57:03', '2024-01-04 21:57:03', '0');
INSERT INTO `order_log` VALUES ('250', '239', null, '0', '提交订单', '2024-01-04 22:53:17', '2024-01-04 22:53:17', '0');
INSERT INTO `order_log` VALUES ('251', '239', null, '1', '支付宝支付成功', '2024-01-04 23:02:55', '2024-01-04 23:02:55', '0');
...
CREATE TABLE `order_statistics` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=298 DEFAULT CHARSET=utf8mb3 COMMENT='订单统计';

-- ----------------------------
-- Records of order_statistics
-- ----------------------------
INSERT INTO `order_statistics` VALUES ('259', null, '2023-11-21', '8565.00', '30', '2023-07-19 12:56:40', '2024-01-04 08:07:37', '0');
INSERT INTO `order_statistics` VALUES ('262', null, '2023-12-09', '10065.00', '5', '2023-07-20 12:57:50', '2024-01-04 08:07:31', '0');
INSERT INTO `order_statistics` VALUES ('263', null, '2023-12-22', '9910.00', '15', '2023-07-22 12:58:00', '2024-01-04 08:07:27', '0');
INSERT INTO `order_statistics` VALUES ('264', null, '2023-12-26', '3223.00', '8', '2023-07-26 12:58:10', '2024-01-04 08:07:23', '0');
INSERT INTO `order_statistics` VALUES ('265', null, '2023-12-27', '20532.00', '9', '2023-12-31 03:27:36', '2024-01-04 08:07:20', '0');
INSERT INTO `order_statistics` VALUES ('289', null, '2023-11-03', '32370.00', '25', '2023-12-31 03:28:01', '2024-01-04 08:07:16', '0');
INSERT INTO `order_statistics` VALUES ('290', null, '2023-11-15', '15034.00', '7', '2023-12-31 03:29:00', '2024-01-04 08:07:12', '0');
INSERT INTO `order_statistics` VALUES ('291', null, '2024-01-03', '4200.00', '20', '2023-12-31 03:29:18', '2024-01-04 08:07:09', '0');
INSERT INTO `order_statistics` VALUES ('292', null, '2024-01-04', '27565.00', '3', '2024-01-04 08:07:07', '2024-01-04 08:07:51', '0');
INSERT INTO `order_statistics` VALUES ('293', null, '2023-12-01', '41614.00', '20', '2024-01-04 17:56:30', '2024-01-04 17:56:30', '0');
INSERT INTO `order_statistics` VALUES ('294', null, '2023-12-06', '9535.00', '6', '2024-01-04 17:56:53', '2024-01-04 17:56:53', '0');
INSERT INTO `order_statistics` VALUES ('295', null, '2023-12-15', '15666.00', '10', '2024-01-04 17:57:15', '2024-01-04 17:57:15', '0');
INSERT INTO `order_statistics` VALUES ('296', null, '2024-01-05', '6592.00', '43', '2024-01-04 17:57:52', '2024-01-04 17:57:52', '0');
INSERT INTO `order_statistics` VALUES ('297', null, '2024-01-06', '24566.00', '12', '2024-01-04 17:58:19', '2024-01-04 17:58:19', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='付款信息表';
...
INSERT INTO `payment_info` VALUES ('81', '34', '1704265298443', '2', null, '4299.00', '华为手机最新款200 + 60L 小米 红米Note10 5G手机 颜色:黑色 内存:8G ', '0', null, null, '2023-12-31 10:34:33', '2023-12-31 10:34:33', '0');
INSERT INTO `payment_info` VALUES ('82', '34', '1704264836296', '2', '2024010422001490380501718237', '2300.00', '华为手机最新款200 + 60L ', '1', '2024-01-04 05:36:04', '{\"gmt_create\":\"2024-01-04 13:36:01\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"华为手机最新款200   60L \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"2300.00\",\"notify_id\":\"2024010401222133602090380501755349\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"2300.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"2300.00\",\"buyer_pay_amount\":\"2300.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-04 13:36:01\",\"notify_time\":\"2024-01-04 13:36:03\",\"version\":\"1.0\",\"out_trade_no\":\"1704264836296\",\"total_amount\":\"2300.00\",\"trade_no\":\"2024010422001490380501718237\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2023-12-31 11:59:28', '2023-12-31 12:00:10', '0');
INSERT INTO `payment_info` VALUES ('83', '34', '1704348541797', '2', '2024010422001490380501711599', '3999.00', '冰箱200 + 60L ', '1', '2024-01-04 06:09:39', '{\"gmt_create\":\"2024-01-04 14:09:36\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"冰箱200   60L \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"3999.00\",\"notify_id\":\"2024010401222140937090380501750522\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"3999.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"3999.00\",\"buyer_pay_amount\":\"3999.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-04 14:09:37\",\"notify_time\":\"2024-01-04 14:09:38\",\"version\":\"1.0\",\"out_trade_no\":\"1704348541797\",\"total_amount\":\"3999.00\",\"trade_no\":\"2024010422001490380501711599\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2023-12-31 12:35:56', '2023-12-31 12:36:32', '0');
INSERT INTO `payment_info` VALUES ('84', '34', '1704350838619', '2', '2024010422001490380501713143', '7599.00', '华为Mate70暗夜紫 + 512G ', '1', '2024-01-04 06:47:55', '{\"gmt_create\":\"2024-01-04 14:47:52\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"华为Mate70暗夜紫   512G \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"7599.00\",\"notify_id\":\"2024010401222144753090380501754131\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"7599.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"7599.00\",\"buyer_pay_amount\":\"7599.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-04 14:47:53\",\"notify_time\":\"2024-01-04 14:47:54\",\"version\":\"1.0\",\"out_trade_no\":\"1704350838619\",\"total_amount\":\"7599.00\",\"trade_no\":\"2024010422001490380501713143\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2023-12-31 12:57:23', '2023-12-31 12:57:58', '0');
INSERT INTO `payment_info` VALUES ('85', '34', '1704351085610', '2', '2024010422001490380501713144', '499.00', '面霜迷你套装 ', '1', '2024-01-04 06:51:38', '{\"gmt_create\":\"2024-01-04 14:51:36\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"面霜迷你套装 \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"499.00\",\"notify_id\":\"2024010401222145137090380501754132\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"499.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"499.00\",\"buyer_pay_amount\":\"499.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-04 14:51:36\",\"notify_time\":\"2024-01-04 14:51:37\",\"version\":\"1.0\",\"out_trade_no\":\"1704351085610\",\"total_amount\":\"499.00\",\"trade_no\":\"2024010422001490380501713144\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2023-12-31 13:01:48', '2023-12-31 13:02:00', '0');
INSERT INTO `payment_info` VALUES ('86', '1', '1704352912536', '2', null, '1999.00', '小米 红米Note10 5G手机 颜色:白色 内存:8G ', '0', null, null, '2023-12-31 13:34:48', '2023-12-31 13:34:48', '0');
INSERT INTO `payment_info` VALUES ('87', '34', '1704353598099', '2', '2024010422001490380501721658', '7599.00', '华为Mate70骑士黑 + 512G ', '1', '2024-01-04 07:33:53', '{\"gmt_create\":\"2024-01-04 15:33:49\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"华为Mate70骑士黑   512G \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"7599.00\",\"notify_id\":\"2024010401222153351090380501755350\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"7599.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"7599.00\",\"buyer_pay_amount\":\"7599.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-04 15:33:50\",\"notify_time\":\"2024-01-04 15:33:52\",\"version\":\"1.0\",\"out_trade_no\":\"1704353598099\",\"total_amount\":\"7599.00\",\"trade_no\":\"2024010422001490380501721658\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2023-12-31 13:47:10', '2023-12-31 13:47:47', '0');
INSERT INTO `payment_info` VALUES ('88', '34', '1704457891970', '2', null, '129.00', '牛仔裤蓝色 + 均码 ', '0', null, null, '2024-01-04 17:10:22', '2024-01-04 17:10:22', '0');
INSERT INTO `payment_info` VALUES ('89', '34', '1704458022892', '2', '2024010522001490380501742420', '35.00', '帽子棕 ', '1', '2024-01-05 12:34:19', '{\"gmt_create\":\"2024-01-05 20:34:15\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"帽子棕 \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"35.00\",\"notify_id\":\"2024010501222203417190380501780033\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"35.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"35.00\",\"buyer_pay_amount\":\"35.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-05 20:34:16\",\"notify_time\":\"2024-01-05 20:34:18\",\"version\":\"1.0\",\"out_trade_no\":\"1704458022892\",\"total_amount\":\"35.00\",\"trade_no\":\"2024010522001490380501742420\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 17:12:45', '2024-01-04 17:13:22', '0');
INSERT INTO `payment_info` VALUES ('90', '36', '1704459256160', '2', '2024010522001490380501737485', '6999.00', '华为Mate70暗夜紫 + 256G ', '1', '2024-01-05 12:54:32', '{\"gmt_create\":\"2024-01-05 20:54:27\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"华为Mate70暗夜紫   256G \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"6999.00\",\"notify_id\":\"2024010501222205429190380501778730\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"6999.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"6999.00\",\"buyer_pay_amount\":\"6999.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-05 20:54:28\",\"notify_time\":\"2024-01-05 20:54:29\",\"version\":\"1.0\",\"out_trade_no\":\"1704459256160\",\"total_amount\":\"6999.00\",\"trade_no\":\"2024010522001490380501737485\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 17:35:00', '2024-01-04 17:35:16', '0');
INSERT INTO `payment_info` VALUES ('91', '36', '1704616807114', '2', null, '109.00', '外套L + 黑色 ', '0', null, null, '2024-01-04 18:18:06', '2024-01-04 18:18:06', '0');
INSERT INTO `payment_info` VALUES ('92', '36', '1704616920452', '2', '2024010722001490380501746588', '99.00', '外套S + 黑色 ', '1', '2024-01-07 08:42:28', '{\"gmt_create\":\"2024-01-07 16:42:24\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"外套S   黑色 \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"99.00\",\"notify_id\":\"2024010701222164225090380501786020\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"99.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"99.00\",\"buyer_pay_amount\":\"99.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-07 16:42:25\",\"notify_time\":\"2024-01-07 16:42:26\",\"version\":\"1.0\",\"out_trade_no\":\"1704616920452\",\"total_amount\":\"99.00\",\"trade_no\":\"2024010722001490380501746588\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 18:20:08', '2024-01-04 18:20:36', '0');
INSERT INTO `payment_info` VALUES ('93', '36', '1704681971929', '2', '2024010822001490380501750948', '129.00', '一双鞋40 + 白 ', '1', '2024-01-08 02:46:33', '{\"gmt_create\":\"2024-01-08 10:46:29\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"一双鞋40   白 \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"129.00\",\"notify_id\":\"2024010801222104631190380501790145\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"129.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"129.00\",\"buyer_pay_amount\":\"129.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-08 10:46:30\",\"notify_time\":\"2024-01-08 10:46:31\",\"version\":\"1.0\",\"out_trade_no\":\"1704681971929\",\"total_amount\":\"129.00\",\"trade_no\":\"2024010822001490380501750948\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 21:40:59', '2024-01-04 21:41:19', '0');
INSERT INTO `payment_info` VALUES ('94', '36', '1704682851119', '2', '2024010822001490380501750949', '10826.00', '一双鞋40 + 棕 外套S + 黑色 华为Mate70骑士黑 + 512G 小米 红米Note10 5G手机 颜色:黑色 内存:18G ', '1', '2024-01-08 03:01:04', '{\"gmt_create\":\"2024-01-08 11:01:00\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"一双鞋40   棕 外套S   黑色 华为Mate70骑士黑   512G 小米 红米Note10 5G手机 颜色:黑色 内存:18G \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"10826.00\",\"notify_id\":\"2024010801222110102090380501797972\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"10826.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"10826.00\",\"buyer_pay_amount\":\"10826.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-08 11:01:01\",\"notify_time\":\"2024-01-08 11:01:03\",\"version\":\"1.0\",\"out_trade_no\":\"1704682851119\",\"total_amount\":\"10826.00\",\"trade_no\":\"2024010822001490380501750949\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 21:56:50', '2024-01-04 21:57:03', '0');
INSERT INTO `payment_info` VALUES ('95', '36', '1704685978894', '2', '2024010822001490380501744825', '16992.00', '面霜超量套装 面霜超量套装 华为Mate70骑士黑 + 512G 素颜霜迷你套装 素颜霜超量套装 外套S + 黑色 一双鞋40 + 白 ', '1', '2024-01-08 04:01:53', '{\"gmt_create\":\"2024-01-08 12:01:48\",\"charset\":\"utf-8\",\"seller_email\":\"doxdie8707@sandbox.com\",\"subject\":\"面霜超量套装 面霜超量套装 华为Mate70骑士黑   512G 素颜霜迷你套装 素颜霜超量套装 外套S   黑色 一双鞋40   白 \",\"buyer_id\":\"2088722026790384\",\"invoice_amount\":\"16992.00\",\"notify_id\":\"2024010801222120150190380501790146\",\"fund_bill_list\":\"[{\\\"amount\\\":\\\"16992.00\\\",\\\"fundChannel\\\":\\\"ALIPAYACCOUNT\\\"}]\",\"notify_type\":\"trade_status_sync\",\"trade_status\":\"TRADE_SUCCESS\",\"receipt_amount\":\"16992.00\",\"buyer_pay_amount\":\"16992.00\",\"app_id\":\"9021000133663001\",\"seller_id\":\"2088721026817509\",\"gmt_payment\":\"2024-01-08 12:01:49\",\"notify_time\":\"2024-01-08 12:01:51\",\"version\":\"1.0\",\"out_trade_no\":\"1704685978894\",\"total_amount\":\"16992.00\",\"trade_no\":\"2024010822001490380501744825\",\"auth_app_id\":\"9021000133663001\",\"buyer_logon_id\":\"hkgobj1433@sandbox.com\",\"point_amount\":\"0.00\"}', '2024-01-04 23:02:15', '2024-01-04 23:02:55', '0');
...
CREATE TABLE `product` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品';
...
INSERT INTO `product` VALUES ('2', '华为笔记本', '2', '1', '41', '42', '个', 'http://139.198.127.41:9000/spzx/20230525/f1d7433dbe88c25e.jpg.avif,http://139.198.127.41:9000/spzx/20230525/4b5a68a9bfbd0795.jpg.avif,http://139.198.127.41:9000/spzx/20230525/13beb824e9dcfc88.jpg.avif,http://139.198.127.41:9000/spzx/20230525/3976e9cfaf7c6ceb.jpg.avif,http://139.198.127.41:9000/spzx/20230525/35b3b7e2e67b98b2.jpg.avif,http://139.198.127.41:9000/spzx/20230525/c8f2eae0d36b6270.jpg.avif,http://139.198.127.41:9000/spzx/20230525/fd5c6bfa6f3c4d43.jpg.avif', '[{\"key\":\"内存\",\"valueList\":[\"8G\",\"16G\",\"32G\"]}]', '1', '1', '审批通过', '2023-05-25 15:18:28', '2023-12-31 05:16:18', '0');
INSERT INTO `product` VALUES ('3', '华为手机最新款1', '2', '1', '2', '3', '台', 'http://127.0.0.1:9000/go-mall/20231229/5645944215ad40e1b0840a8e8074948f2.jpg,http://127.0.0.1:9000/go-mall/20231229/186fcb203cba4b79984b7293e1c83c7b3.jpg,http://127.0.0.1:9000/go-mall/20231229/4c94a15fcf8042dea18e664f4b04cde34.jpg,http://127.0.0.1:9000/go-mall/20231229/28acc44024254825b1bb41c5e75477a85.jpg', '[{\"key\":\"高度\",\"valueList\":[\"200\"]},{\"key\":\"容积\",\"valueList\":[\"60L\"]}]', '1', '1', '审批通过', '2023-07-19 11:01:11', '2023-12-29 05:17:19', '0');
INSERT INTO `product` VALUES ('4', '手机测试', '2', '1', '2', '3', '台', 'http://127.0.0.1:9000/go-mall/20231229/eb5694759ac14556b703cb19a3c7f57f1.jpg,http://127.0.0.1:9000/go-mall/20231229/fc624b1e31144c24a4899a4327dfaaa02.jpg,http://127.0.0.1:9000/go-mall/20231229/2bcbf2de2929400e95fd8f21861dbf003.jpg,http://127.0.0.1:9000/go-mall/20231229/1d63a732b1da457b8077335eb74b97634.jpg', '[{\"key\":\"高度\",\"valueList\":[\"200\"]},{\"key\":\"容积\",\"valueList\":[\"60L\"]}]', '-1', '1', '审批通过', '2023-12-29 02:24:23', '2023-12-31 04:34:34', '1');
INSERT INTO `product` VALUES ('5', 'iPhone', '1', '1', '2', '3', '台', 'http://127.0.0.1:9000/go-mall/20231229/1f311f92c9124d1f88db1206ff6cc4572.jpg,http://127.0.0.1:9000/go-mall/20231229/146468f3650c44529ff5862f1a90d56c3.jpg,http://127.0.0.1:9000/go-mall/20231229/c3e7564ddbc940fa9ca0d1624e72fb3d4.jpg', '[{\"key\":\"高度\",\"valueList\":[\"200\"]},{\"key\":\"容积\",\"valueList\":[\"60L\"]}]', '1', '1', '审批通过', '2023-12-29 02:58:19', '2023-12-31 05:16:37', '0');
INSERT INTO `product` VALUES ('6', '外套', '11', '174', '196', '207', '件', 'http://127.0.0.1:9000/go-mall/20240103/8f0b0c875e864c99ae5c01638a3576822-3.jpg,http://127.0.0.1:9000/go-mall/20240103/5ee70469a1a44fa1b5943117cef8c4512-4.jpg,http://127.0.0.1:9000/go-mall/20240103/f483e29b2e9e4df798e244eed38b32922-1.jpg,http://127.0.0.1:9000/go-mall/20240103/3b3ee8c91a0143109a07c863c04438b42-5.jpg', '[{\"key\":\"尺寸\",\"valueList\":[\"S\",\"L\",\"XL\"]},{\"key\":\"颜色\",\"valueList\":[\"黑色\",\"灰色\"]}]', '1', '1', '审批通过', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product` VALUES ('7', '牛仔裤', '5', '174', '196', '210', '件', 'http://127.0.0.1:9000/go-mall/20240103/285a0b8891a74348981f77cb18ef436c3-1.jpg,http://127.0.0.1:9000/go-mall/20240103/545495be0b454427b9ec9c01e6b23bfb3-2.jpg,http://127.0.0.1:9000/go-mall/20240103/df528ad24f994b10b5477089e97c56703-3.jpg,http://127.0.0.1:9000/go-mall/20240103/4f3e40786fb142008c69f5a0f17787f23-4.jpg', '[{\"key\":\"颜色\",\"valueList\":[\"黑色\",\"蓝色\"]},{\"key\":\"尺寸\",\"valueList\":[\"均码\"]}]', '1', '1', '审批通过', '2023-12-31 05:05:51', '2023-12-31 12:47:49', '0');
INSERT INTO `product` VALUES ('8', '帽子', '5', '174', '282', '288', '个', 'http://127.0.0.1:9000/go-mall/20240103/558c4dc238294011b0c78ffea1a5ccf84-2.jpg,http://127.0.0.1:9000/go-mall/20240103/89a0e42ab98c47f299e4d2d53d3c08024-3.jpg,http://127.0.0.1:9000/go-mall/20240103/a8a5c1cea0494cedb6b36f08454f38bb4-1.jpg,http://127.0.0.1:9000/go-mall/20240103/80577c5b4a054f558c7a406e15ab27184-4.jpg', '[{\"key\":\"颜色\",\"valueList\":[\"棕\",\"白\"]}]', '1', '1', '审批通过', '2023-12-31 05:09:15', '2023-12-31 12:47:08', '0');
INSERT INTO `product` VALUES ('9', '面霜', '12', '430', '431', '435', '包', 'http://127.0.0.1:9000/go-mall/20240103/e9ad43cc70424d29be25dba8a50864643-2.jpg,http://127.0.0.1:9000/go-mall/20240103/b68c98032e954223b73346680cce20853-3.jpg,http://127.0.0.1:9000/go-mall/20240103/78dfac69ded64f64b4b50fc8c0ef08b83-4.jpg,http://127.0.0.1:9000/go-mall/20240103/9649e11101cd4959b910d05546e1dd913-1.jpg', '[{\"key\":\"规格\",\"valueList\":[\"迷你套装\",\"超量套装\"]}]', '1', '1', '审批通过', '2023-12-31 05:15:07', '2023-12-31 12:46:16', '0');
INSERT INTO `product` VALUES ('10', '冰箱', '1', '119', '120', '123', '台', 'http://127.0.0.1:9000/go-mall/20240103/ea3d9c377b9d47c1ae13fbccebf6858f3-2.jpg,http://127.0.0.1:9000/go-mall/20240103/7e21f67b64e141d99a8ea100edcde0773-3.jpg,http://127.0.0.1:9000/go-mall/20240103/4172cdf8645d486bb7df3c852e986ba13-4.jpg', '[{\"key\":\"高度\",\"valueList\":[\"200\"]},{\"key\":\"容积\",\"valueList\":[\"60L\"]}]', '1', '1', '审批通过', '2023-12-31 05:19:35', '2023-12-31 12:45:21', '0');
INSERT INTO `product` VALUES ('11', '面霜', '12', '430', '431', '435', '个', 'http://127.0.0.1:9000/go-mall/20240103/5cb630ba0f8c4eb18a8d0f6f80ecdf451-1.jpg,http://127.0.0.1:9000/go-mall/20240103/13fdd63721b449b498d3dd0217a668331-2.jpg,http://127.0.0.1:9000/go-mall/20240103/986ac748b4ef4aa6ae67b861269b973d1-3.jpg,http://127.0.0.1:9000/go-mall/20240103/5d1b7c1677984c118fdecd5feb2aad191-4.jpg', '[{\"key\":\"规格\",\"valueList\":[\"迷你套装\",\"超量套装\"]}]', '1', '1', '审批通过', '2023-12-31 05:53:42', '2023-12-31 12:44:46', '0');
INSERT INTO `product` VALUES ('12', '华为Mate70', '2', '1', '2', '3', '部', 'http://127.0.0.1:9000/go-mall/20240104/51a466f41e674b84a9889989ed8939f62.jpg,http://127.0.0.1:9000/go-mall/20240104/cc28d42e83a343e9b785d5e05a2981864.jpg,http://127.0.0.1:9000/go-mall/20240104/2f63925144644788b7c25a96e6679e885.jpg', '[{\"key\":\"颜色\",\"valueList\":[\"暗夜紫\",\"骑士黑\"]},{\"key\":\"内存\",\"valueList\":[\"256G\",\"512G\"]}]', '1', '1', '审批通过', '2023-12-31 12:55:59', '2024-01-04 20:22:14', '0');
INSERT INTO `product` VALUES ('13', '素颜面霜', '12', '430', '431', '435', '个', 'http://127.0.0.1:9000/go-mall/20240105/7b35ae35e47c4c8898c46143f33d86492-1.jpg,http://127.0.0.1:9000/go-mall/20240105/e1d41c91a5d445c1a083945b7644f24d2-2.jpg,http://127.0.0.1:9000/go-mall/20240105/4549ef361cb94beda992637fe6d3690f2-3.jpg,http://127.0.0.1:9000/go-mall/20240105/b0ed5ff008884029abf274a1660d44342-4.jpg', '[{\"key\":\"规格\",\"valueList\":[\"迷你套装\",\"超量套装\"]}]', '1', '1', '审批通过', '2024-01-04 12:00:12', '2024-01-04 17:28:07', '0');
INSERT INTO `product` VALUES ('14', '一双鞋', '19', '174', '269', '272', '双', 'http://127.0.0.1:9000/go-mall/20240108/a0cc396b1c3a4f93af9eb3fd582f2fd71.jpg,http://127.0.0.1:9000/go-mall/20240108/721d963a4d314b24aeba85f12b2dcb6e2.jpg,http://127.0.0.1:9000/go-mall/20240108/f040803775214f7294eed318b7121f1e3.jpg,http://127.0.0.1:9000/go-mall/20240108/782814b2012b48cfa8a4e2c677f4cd385.jpg', '[{\"key\":\"尺码\",\"valueList\":[\"40\"]},{\"key\":\"颜色\",\"valueList\":[\"白\",\"棕\"]}]', '1', '1', '审批通过', '2024-01-04 19:32:51', '2024-01-04 21:40:24', '0');
...
CREATE TABLE `product_details` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品sku属性表';
...
INSERT INTO `product_details` VALUES ('3', '3', 'http://127.0.0.1:9000/go-mall/20231229/fa00f916d7bf4851a458760aade286001.jpg', '2023-07-19 11:01:11', '2023-12-29 05:17:19', '0');
INSERT INTO `product_details` VALUES ('4', '4', 'http://127.0.0.1:9000/go-mall/20231229/d6744b03a83a4d2a876e8ba2c08585361.jpg', '2023-12-29 02:24:23', '2023-12-31 04:34:34', '1');
INSERT INTO `product_details` VALUES ('5', '5', 'http://127.0.0.1:9000/go-mall/20231229/e7197513566a41c59a69868e181c24181.jpg', '2023-12-29 02:58:19', '2023-12-29 05:15:23', '0');
INSERT INTO `product_details` VALUES ('6', '6', 'http://127.0.0.1:9000/go-mall/20240103/d665ab4d0a96438d86b456e2d81d4b912-3.jpg', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_details` VALUES ('7', '7', 'http://127.0.0.1:9000/go-mall/20240103/14084b1b595d4407aadfae5ddac25b423-5.jpg', '2023-12-31 05:05:51', '2023-12-31 12:47:49', '0');
INSERT INTO `product_details` VALUES ('8', '8', 'http://127.0.0.1:9000/go-mall/20240103/2939941b0fe54ae9b2321fb5c727fe594-1.jpg', '2023-12-31 05:09:15', '2023-12-31 12:47:08', '0');
INSERT INTO `product_details` VALUES ('9', '9', 'http://127.0.0.1:9000/go-mall/20240103/ce632752bbf647bc9d868bed8d6d9e173-1.jpg', '2023-12-31 05:15:07', '2023-12-31 12:46:16', '0');
INSERT INTO `product_details` VALUES ('10', '10', 'http://127.0.0.1:9000/go-mall/20240103/6d67f8275a404ff98957db9c199d2fdc3-1.jpg', '2023-12-31 05:19:35', '2023-12-31 12:45:21', '0');
INSERT INTO `product_details` VALUES ('11', '11', 'http://127.0.0.1:9000/go-mall/20240103/76a113db61f74c9392706fbbce2d20c81-5.jpg', '2023-12-31 05:53:42', '2023-12-31 12:44:46', '0');
INSERT INTO `product_details` VALUES ('12', '12', 'http://127.0.0.1:9000/go-mall/20240104/6eb0c051797843e1846a636547d4c6531.jpg,http://127.0.0.1:9000/go-mall/20240104/c22ae65bc7764a6f87ee037f23f9515e4.jpg', '2023-12-31 12:55:59', '2024-01-04 20:22:14', '0');
INSERT INTO `product_details` VALUES ('13', '13', 'http://127.0.0.1:9000/go-mall/20240105/5b1fd519ded748aabd7788312f9c6d382-2.jpg', '2024-01-04 12:00:12', '2024-01-04 17:27:54', '0');
INSERT INTO `product_details` VALUES ('14', '14', 'http://127.0.0.1:9000/go-mall/20240108/88803f3ae1d0485c9ee4a41a567f3dca4.jpg,http://127.0.0.1:9000/go-mall/20240108/0eeff0f20301437ebf334a7cb0ed62562.jpg', '2024-01-04 19:32:51', '2024-01-04 19:32:51', '0');
...
INSERT INTO `product_sku` VALUES ('6', '1_5', '小米 红米Note10 5G手机 颜色:黑色 内存:18G', '1', 'http://139.198.127.41:9000/spzx/20230525/665832167-1_u_1.jpg', '2999.00', '3019.00', '2599.00', '98', '2', '颜色:黑色,内存:18G', '1.00', '1.00', null, '2023-05-25 14:21:07', '2024-01-04 21:57:03', '0');
...
INSERT INTO `product_sku` VALUES ('10', '3_0', '华为手机最新款200 + 60L', '3', 'http://127.0.0.1:9000/go-mall/20231229/fd26a7c4b9f24131a4f17a9465518fcc1.jpg', '2300.00', '2500.00', '200.00', '1', '0', '200 + 60L', '1.00', '20.00', '0', '2023-07-19 11:01:11', '2023-12-29 05:17:19', '0');
INSERT INTO `product_sku` VALUES ('11', '4_0', '手机测试200 + 60L', '4', 'http://127.0.0.1:9000/go-mall/20231229/d5a158a2086f4415ad0c8dfb6b33b6145.jpg', '1999.00', '1999.00', '1699.00', '10', '0', '200 + 60L', '30.00', '60.00', '0', '2023-12-29 02:24:23', '2023-12-31 04:34:34', '1');
INSERT INTO `product_sku` VALUES ('12', '5_0', 'iPhone200 + 60L', '5', 'http://127.0.0.1:9000/go-mall/20231229/ffa50ca3ea974fe78daf6ca1f101857e1.jpg', '1122.00', '1122.00', '5555.00', '12', '0', '200 + 60L', '222.00', '11.00', '0', '2023-12-29 02:58:19', '2023-12-29 05:14:44', '0');
INSERT INTO `product_sku` VALUES ('13', '6_0', '外套S + 黑色', '6', 'http://127.0.0.1:9000/go-mall/20240104/7027f542320a422fac77e3f9015bfb3b2-2.jpg', '99.00', '109.00', '59.00', '87', '3', 'S + 黑色', '30.00', '10.00', '0', '2023-12-31 05:01:33', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('14', '6_1', '外套S + 灰色', '6', 'http://127.0.0.1:9000/go-mall/20240104/47ce93119f1140a3b57f373000a80a7e2-4.jpg', '99.00', '109.00', '59.00', '90', '0', 'S + 灰色', '30.00', '10.00', '0', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_sku` VALUES ('15', '6_2', '外套L + 黑色', '6', 'http://127.0.0.1:9000/go-mall/20240104/b435e2bd97c5492e9c0fc2de9c5ca2802-1.jpg', '109.00', '119.00', '60.00', '20', '0', 'L + 黑色', '32.00', '10.00', '0', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_sku` VALUES ('16', '6_3', '外套L + 灰色', '6', 'http://127.0.0.1:9000/go-mall/20240104/fe0e1e7e285a4c34a8edb819328a55222-2.jpg', '109.00', '119.00', '60.00', '15', '0', 'L + 灰色', '32.00', '10.00', '0', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_sku` VALUES ('17', '6_4', '外套XL + 黑色', '6', 'http://127.0.0.1:9000/go-mall/20240104/1108875314ad48fca9511a193fc9224c2-5.jpg', '119.00', '139.00', '60.00', '2', '0', 'XL + 黑色', '35.00', '10.00', '0', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_sku` VALUES ('18', '6_5', '外套XL + 灰色', '6', 'http://127.0.0.1:9000/go-mall/20240104/16b6bf54c9a8416096b6846b1a883c232-3.jpg', '119.00', '139.00', '60.00', '6', '0', 'XL + 灰色', '35.00', '10.00', '0', '2023-12-31 05:01:33', '2023-12-31 12:49:03', '0');
INSERT INTO `product_sku` VALUES ('19', '7_0', '牛仔裤黑色 + 均码', '7', 'http://127.0.0.1:9000/go-mall/20240104/020ef047448f4dc6a18e9df6faa960213-5.jpg', '179.00', '199.00', '99.00', '30', '0', '黑色 + 均码', '10.00', '10.00', '0', '2023-12-31 05:05:51', '2023-12-31 12:47:49', '0');
INSERT INTO `product_sku` VALUES ('20', '7_1', '牛仔裤蓝色 + 均码', '7', 'http://127.0.0.1:9000/go-mall/20240104/8315511678d54a358a86940ed0842d083-2.jpg', '129.00', '135.00', '79.00', '20', '0', '蓝色 + 均码', '10.00', '10.00', '0', '2023-12-31 05:05:51', '2023-12-31 12:47:49', '0');
INSERT INTO `product_sku` VALUES ('21', '8_0', '帽子棕', '8', 'http://127.0.0.1:9000/go-mall/20240104/91978beab0dc4469b0d04d555b5214054-1.jpg', '35.00', '50.00', '12.00', '66', '1', '棕', '11.00', '11.00', '0', '2023-12-31 05:09:15', '2024-01-04 17:13:22', '0');
INSERT INTO `product_sku` VALUES ('22', '8_1', '帽子白', '8', 'http://127.0.0.1:9000/go-mall/20240104/b7e871f42d36468abd2eb132d43e1c214-2.jpg', '33.00', '50.00', '12.00', '23', '0', '白', '11.00', '11.00', '0', '2023-12-31 05:09:15', '2023-12-31 12:47:08', '0');
INSERT INTO `product_sku` VALUES ('23', '9_0', '面霜迷你套装', '9', 'http://127.0.0.1:9000/go-mall/20240104/8949d98523244e19867df87b7d8cbb703-1.jpg', '299.00', '399.00', '99.00', '76', '0', '迷你套装', '76.00', '80.00', '0', '2023-12-31 05:15:07', '2023-12-31 12:46:16', '0');
INSERT INTO `product_sku` VALUES ('24', '9_1', '面霜超量套装', '9', 'http://127.0.0.1:9000/go-mall/20240104/44ba0397aa5a4074b5d90d2c24cc78f93-2.jpg', '499.00', '799.00', '199.00', '40', '1', '超量套装', '170.00', '200.00', '0', '2023-12-31 05:15:07', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('25', '10_0', '冰箱200 + 60L', '10', 'http://127.0.0.1:9000/go-mall/20240104/692e1b2b45754b75b857980e113961d23-4.jpg', '2599.00', '3999.00', '2000.00', '75', '0', '200 + 60L', '60.00', '60.00', '0', '2023-12-31 05:19:35', '2023-12-31 12:45:21', '0');
INSERT INTO `product_sku` VALUES ('26', '11_0', '面霜迷你套装', '11', 'http://127.0.0.1:9000/go-mall/20240104/b6e7cad626a44d20b0c8d54b9180d7ef1-3.jpg', '499.00', '599.00', '399.00', '13', '0', '迷你套装', '14.00', '12.00', '0', '2023-12-31 05:53:42', '2023-12-31 12:44:46', '0');
INSERT INTO `product_sku` VALUES ('27', '11_1', '面霜超量套装', '11', 'http://127.0.0.1:9000/go-mall/20240104/b1d0b4ec52c4465788927103d903f9da1-1.jpg', '899.00', '1099.00', '799.00', '63', '1', '超量套装', '23.00', '21.00', '0', '2023-12-31 05:53:42', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('28', '12_0', '华为Mate70暗夜紫 + 256G', '12', 'http://127.0.0.1:9000/go-mall/20240104/bdfc7a5ddbe84cc2903c30e21819cc4c1.jpg', '6999.00', '7299.00', '6599.00', '99', '1', '暗夜紫 + 256G', '54.00', '43.00', '0', '2023-12-31 12:55:59', '2024-01-04 20:22:14', '0');
INSERT INTO `product_sku` VALUES ('29', '12_1', '华为Mate70暗夜紫 + 512G', '12', 'http://127.0.0.1:9000/go-mall/20240104/6e045adff50f4582a23541b64838bbd02.jpg', '7599.00', '7999.00', '7099.00', '200', '0', '暗夜紫 + 512G', '65.00', '50.00', '0', '2023-12-31 12:55:59', '2024-01-04 20:22:14', '0');
INSERT INTO `product_sku` VALUES ('30', '12_2', '华为Mate70骑士黑 + 256G', '12', 'http://127.0.0.1:9000/go-mall/20240104/dbd7a5629096446aaf87595a6c9db4664.jpg', '6999.00', '7299.00', '6599.00', '120', '4', '骑士黑 + 256G', '54.00', '43.00', '0', '2023-12-31 12:55:59', '2024-01-04 20:22:14', '0');
INSERT INTO `product_sku` VALUES ('31', '12_3', '华为Mate70骑士黑 + 512G', '12', 'http://127.0.0.1:9000/go-mall/20240104/6528cd4f2ff84f229f005f611798c2c13.jpg', '7599.00', '7999.00', '7099.00', '227', '8', '骑士黑 + 512G', '65.00', '50.00', '0', '2023-12-31 12:55:59', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('32', '13_0', '素颜霜迷你套装', '13', 'http://127.0.0.1:9000/go-mall/20240105/693f7d3df4fb456b993e5139a5cb99c02-1.jpg', '59.00', '69.00', '30.00', '641', '36', '迷你套装', '4.00', '4.00', '0', '2024-01-04 12:00:12', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('33', '13_1', '素颜霜超量套装', '13', 'http://127.0.0.1:9000/go-mall/20240105/40d260ed52e349c6a2f5b853e2c018de2-4.jpg', '109.00', '129.00', '30.00', '430', '1', '超量套装', '9.00', '9.00', '0', '2024-01-04 12:00:12', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('34', '14_0', '一双鞋40 + 白', '14', 'http://127.0.0.1:9000/go-mall/20240108/e9ab12d9594346cc9b4ad4114b7896432.jpg', '129.00', '139.00', '99.00', '58', '9', '40 + 白', '12.00', '12.00', '0', '2024-01-04 19:32:51', '2024-01-04 23:02:55', '0');
INSERT INTO `product_sku` VALUES ('35', '14_1', '一双鞋40 + 棕', '14', 'http://127.0.0.1:9000/go-mall/20240108/50b0b67c07a94b1ba3ef72b150841ea06.jpg', '129.00', '139.00', '99.00', '89', '5', '40 + 棕', '12.00', '12.00', '0', '2024-01-04 19:32:51', '2024-01-04 21:57:03', '0');
...
CREATE TABLE `product_spec` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品规格';
...
INSERT INTO `product_spec` VALUES ('10', '钢笔', '[{\"key\":\"颜色\",\"valueList\":[\"白色\",\"黑色\",\"红色\",\"绿色\"]},{\"key\":\"墨汁\",\"valueList\":[\"红色\",\"黑色\",\"蓝色\"]},{\"key\":\"笔尖\",\"valueList\":[\"0.5\",\"1\"]}]', '2023-12-28 07:58:32', '2023-12-31 04:54:36', '1');
INSERT INTO `product_spec` VALUES ('11', 'test', '[{\"key\":\"尺寸\",\"valueList\":[\"五彩斑斓的黑\"]}]', '2023-12-28 07:59:02', '2023-12-28 07:59:23', '1');
INSERT INTO `product_spec` VALUES ('12', '电脑', '[{\"key\":\"内存\",\"valueList\":[\"16G\",\"100G\"]},{\"key\":\"颜色\",\"valueList\":[\"红\",\"黄\",\"黑\"]}]', '2023-12-29 02:56:57', '2023-12-29 02:57:11', '1');
INSERT INTO `product_spec` VALUES ('13', '服装', '[{\"key\":\"尺寸\",\"valueList\":[\"S\",\"L\",\"XL\"]},{\"key\":\"颜色\",\"valueList\":[\"黑色\",\"灰色\"]}]', '2023-12-31 04:57:37', '2023-12-31 04:57:37', '0');
INSERT INTO `product_spec` VALUES ('14', '裤子', '[{\"key\":\"颜色\",\"valueList\":[\"黑色\",\"蓝色\"]},{\"key\":\"尺寸\",\"valueList\":[\"均码\"]}]', '2023-12-31 05:03:19', '2023-12-31 05:03:19', '0');
INSERT INTO `product_spec` VALUES ('15', '帽子', '[{\"key\":\"颜色\",\"valueList\":[\"棕\",\"白\"]}]', '2023-12-31 05:07:41', '2023-12-31 05:07:41', '0');
INSERT INTO `product_spec` VALUES ('16', '化妆品', '[{\"key\":\"规格\",\"valueList\":[\"迷你套装\",\"超量套装\"]}]', '2023-12-31 05:12:28', '2024-01-04 15:23:50', '0');
INSERT INTO `product_spec` VALUES ('17', '鞋子', '[{\"key\":\"尺码\",\"valueList\":[\"36\",\"37\"]},{\"key\":\"颜色\",\"valueList\":[\"黑色\",\"白色\"]}]', '2023-12-31 05:50:21', '2023-12-31 05:51:00', '1');
INSERT INTO `product_spec` VALUES ('18', '杯子', '[{\"key\":\"颜色\",\"valueList\":[\"红色\",\"白色\"]},{\"key\":\"容量\",\"valueList\":[\"500ml\"]}]', '2024-01-04 15:24:09', '2024-01-04 17:26:37', '0');
INSERT INTO `product_spec` VALUES ('19', '鞋子', '[{\"key\":\"尺码\",\"valueList\":[\"40\"]},{\"key\":\"颜色\",\"valueList\":[\"白\",\"棕\"]}]', '2024-01-04 18:12:57', '2024-01-04 18:12:57', '0');
INSERT INTO `product_spec` VALUES ('20', '饮品', '[{\"key\":\"种类\",\"valueList\":[\"茉莉花茶\",\"绿茶\"]}]', '2024-01-04 22:01:17', '2024-01-04 22:03:03', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单表';
...
INSERT INTO `sys_menu` VALUES ('31', '1', '测试bug', '测试bug', '7', '1', '2023-12-26 19:09:07', '2023-12-31 03:32:29', '1');
INSERT INTO `sys_menu` VALUES ('33', '1', '测试bug1', '测试bug1', '6', '1', '2023-12-26 19:13:16', '2023-12-31 03:32:26', '1');
INSERT INTO `sys_menu` VALUES ('34', '1', '测试bug2', '测试bug2', '7', '1', '2023-12-26 19:34:23', '2023-12-31 03:32:32', '1');
INSERT INTO `sys_menu` VALUES ('35', '0', 'test1', 'test1', '7', '1', '2023-12-31 05:45:22', '2023-12-31 05:45:56', '1');
INSERT INTO `sys_menu` VALUES ('36', '35', '213', '212', '2', '1', '2023-12-31 05:45:36', '2023-12-31 05:45:42', '1');
INSERT INTO `sys_menu` VALUES ('37', '1', '222', '222', '4', '1', '2024-01-04 17:22:45', '2024-01-04 17:22:55', '1');
...
CREATE TABLE `sys_oper_log` (
  ...
  `json_result` varchar(5000) DEFAULT NULL,
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8mb3 COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('80', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":5,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":5,\"startRow\":1,\"total\":5},\"message\":\"操作成功\"}', '0', null, '2023-12-29 10:41:37', null, '0');
INSERT INTO `sys_oper_log` VALUES ('81', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=17, roleIdList=[37])]', 'null', '1', '/ by zero', '2023-12-29 10:50:28', null, '0');
INSERT INTO `sys_oper_log` VALUES ('82', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=17, roleIdList=[37])]', 'null', '1', '/ by zero', '2023-12-29 10:51:31', null, '0');
INSERT INTO `sys_oper_log` VALUES ('83', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=14, roleIdList=[37])]', 'null', '0', null, '2023-12-29 10:59:03', null, '0');
INSERT INTO `sys_oper_log` VALUES ('84', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=19, roleIdList=[36])]', 'null', '0', null, '2023-12-31 03:50:42', null, '0');
INSERT INTO `sys_oper_log` VALUES ('85', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":5,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":5,\"startRow\":1,\"total\":5},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:34:42', null, '0');
INSERT INTO `sys_oper_log` VALUES ('86', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":6,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:35:37\",\"id\":10,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg\",\"name\":\"巧夫人\",\"updateTime\":\"2023-12-31 04:35:37\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":6,\"startRow\":1,\"total\":6},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:35:37', null, '0');
INSERT INTO `sys_oper_log` VALUES ('87', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":7,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-31 04:35:37\",\"id\":10,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg\",\"name\":\"巧夫人\",\"updateTime\":\"2023-12-31 04:35:37\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":7,\"startRow\":1,\"total\":7},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:36:02', null, '0');
INSERT INTO `sys_oper_log` VALUES ('88', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-31 04:35:37\",\"id\":10,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg\",\"name\":\"巧夫人\",\"updateTime\":\"2023-12-31 04:35:37\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:36:21', null, '0');
INSERT INTO `sys_oper_log` VALUES ('89', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-31 04:35:37\",\"id\":10,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg\",\"name\":\"巧夫人\",\"updateTime\":\"2023-12-31 04:35:37\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:52:08', null, '0');
INSERT INTO `sys_oper_log` VALUES ('90', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-31 04:35:37\",\"id\":10,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/153c5d935ef14143a0596e1f910abfb9巧夫人.jpg\",\"name\":\"巧夫人\",\"updateTime\":\"2023-12-31 04:35:37\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:56:02', null, '0');
INSERT INTO `sys_oper_log` VALUES ('91', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 04:56:14', null, '0');
INSERT INTO `sys_oper_log` VALUES ('92', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:01:41', null, '0');
INSERT INTO `sys_oper_log` VALUES ('93', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:02:07', null, '0');
INSERT INTO `sys_oper_log` VALUES ('94', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:02:28', null, '0');
INSERT INTO `sys_oper_log` VALUES ('95', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:06:34', null, '0');
INSERT INTO `sys_oper_log` VALUES ('96', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:09:29', null, '0');
INSERT INTO `sys_oper_log` VALUES ('97', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:10:01', null, '0');
INSERT INTO `sys_oper_log` VALUES ('98', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:17:00', null, '0');
INSERT INTO `sys_oper_log` VALUES ('99', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:17:01', null, '0');
INSERT INTO `sys_oper_log` VALUES ('100', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:17:28', null, '0');
INSERT INTO `sys_oper_log` VALUES ('101', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:19:39', null, '0');
INSERT INTO `sys_oper_log` VALUES ('102', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=14, roleIdList=[37, 36])]', 'null', '0', null, '2023-12-31 05:44:27', null, '0');
INSERT INTO `sys_oper_log` VALUES ('103', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:46:40', null, '0');
INSERT INTO `sys_oper_log` VALUES ('104', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 05:47:34\",\"id\":16,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/1fd276fa800b4c859014b5848af4d76f荣事达.jpg\",\"name\":\"荣事达\",\"updateTime\":\"2023-12-31 05:47:34\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:47:34', null, '0');
INSERT INTO `sys_oper_log` VALUES ('105', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 05:47:34\",\"id\":16,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/1fd276fa800b4c859014b5848af4d76f荣事达.jpg\",\"name\":\"荣事达1\",\"updateTime\":\"2023-12-31 05:47:41\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:47:41', null, '0');
INSERT INTO `sys_oper_log` VALUES ('106', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 05:47:34\",\"id\":16,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/dda60958178e4d94a03328e126291f98巧夫人.jpg\",\"name\":\"荣事达1\",\"updateTime\":\"2023-12-31 05:47:49\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:47:49', null, '0');
INSERT INTO `sys_oper_log` VALUES ('107', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:48:03', null, '0');
INSERT INTO `sys_oper_log` VALUES ('108', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=14, roleIdList=[36])]', 'null', '0', null, '2023-12-31 05:55:52', null, '0');
INSERT INTO `sys_oper_log` VALUES ('109', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'lilei', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2023-12-31 05:56:22', null, '0');
INSERT INTO `sys_oper_log` VALUES ('110', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 08:08:09', null, '0');
INSERT INTO `sys_oper_log` VALUES ('111', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 10:49:30', null, '0');
INSERT INTO `sys_oper_log` VALUES ('112', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 11:55:45', null, '0');
INSERT INTO `sys_oper_log` VALUES ('113', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 11:57:04', null, '0');
INSERT INTO `sys_oper_log` VALUES ('114', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 11:57:19', null, '0');
INSERT INTO `sys_oper_log` VALUES ('115', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 11:57:27', null, '0');
INSERT INTO `sys_oper_log` VALUES ('116', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 15:21:39', null, '0');
INSERT INTO `sys_oper_log` VALUES ('117', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 15:21:53\",\"id\":17,\"isDeleted\":0,\"name\":\"a\",\"updateTime\":\"2024-01-04 15:21:53\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 15:21:53', null, '0');
INSERT INTO `sys_oper_log` VALUES ('118', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 15:21:53\",\"id\":17,\"isDeleted\":0,\"name\":\"b\",\"updateTime\":\"2024-01-04 15:22:00\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 15:22:00', null, '0');
INSERT INTO `sys_oper_log` VALUES ('119', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 15:22:09', null, '0');
INSERT INTO `sys_oper_log` VALUES ('120', '用户分配角色', 'com.beidao.mall.manager.service.impl.SysUserServiceImpl', 'POST', 'MANAGE', 'admin', '/admin/system/sysUser/doAssign', '0:0:0:0:0:0:0:1', '[AssginRoleDto(userId=17, roleIdList=[37, 9])]', 'null', '0', null, '2024-01-04 17:21:46', null, '0');
INSERT INTO `sys_oper_log` VALUES ('121', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:23:48', null, '0');
INSERT INTO `sys_oper_log` VALUES ('122', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:23:57\",\"id\":18,\"isDeleted\":0,\"name\":\"2112\",\"updateTime\":\"2024-01-04 17:23:57\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:23:57', null, '0');
INSERT INTO `sys_oper_log` VALUES ('123', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":8,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":8,\"startRow\":1,\"total\":8},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:24:22', null, '0');
INSERT INTO `sys_oper_log` VALUES ('124', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"1111\",\"updateTime\":\"2024-01-04 17:24:41\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:24:41', null, '0');
INSERT INTO `sys_oper_log` VALUES ('125', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:24:59', null, '0');
INSERT INTO `sys_oper_log` VALUES ('126', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'lilei', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:29:03', null, '0');
INSERT INTO `sys_oper_log` VALUES ('127', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:55:28', null, '0');
INSERT INTO `sys_oper_log` VALUES ('128', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 17:59:08', null, '0');
INSERT INTO `sys_oper_log` VALUES ('129', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 18:13:05', null, '0');
INSERT INTO `sys_oper_log` VALUES ('130', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 18:14:25', null, '0');
INSERT INTO `sys_oper_log` VALUES ('131', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 18:34:29', null, '0');
INSERT INTO `sys_oper_log` VALUES ('132', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 19:29:07', null, '0');
INSERT INTO `sys_oper_log` VALUES ('133', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 19:30:27', null, '0');
INSERT INTO `sys_oper_log` VALUES ('134', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 19:56:10', null, '0');
INSERT INTO `sys_oper_log` VALUES ('135', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 19:56:12', null, '0');
INSERT INTO `sys_oper_log` VALUES ('136', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":9,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":9,\"startRow\":1,\"total\":9},\"message\":\"操作成功\"}', '0', null, '2024-01-04 22:00:38', null, '0');
INSERT INTO `sys_oper_log` VALUES ('137', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":10,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 22:00:51\",\"id\":20,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240108/cd78fe7109094ede9ff04e6a6ba37dba1.jpg\",\"name\":\"农夫山泉\",\"updateTime\":\"2024-01-04 22:00:51\"},{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":10,\"startRow\":1,\"total\":10},\"message\":\"操作成功\"}', '0', null, '2024-01-04 22:00:51', null, '0');
INSERT INTO `sys_oper_log` VALUES ('138', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":10,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 22:00:51\",\"id\":20,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240108/cd78fe7109094ede9ff04e6a6ba37dba1.jpg\",\"name\":\"农夫山泉\",\"updateTime\":\"2024-01-04 22:00:51\"},{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":10,\"startRow\":1,\"total\":10},\"message\":\"操作成功\"}', '0', null, '2024-01-04 22:01:39', null, '0');
INSERT INTO `sys_oper_log` VALUES ('139', '品牌管理:列表', 'com.beidao.mall.manager.controller.BrandController', 'GET', 'MANAGE', 'admin', '/admin/product/brand/1/10', '0:0:0:0:0:0:0:1', null, '{\"code\":200,\"data\":{\"endRow\":10,\"hasNextPage\":false,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":true,\"list\":[{\"createTime\":\"2024-01-04 22:00:51\",\"id\":20,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240108/cd78fe7109094ede9ff04e6a6ba37dba1.jpg\",\"name\":\"农夫山泉\",\"updateTime\":\"2024-01-04 22:00:51\"},{\"createTime\":\"2024-01-04 17:24:41\",\"id\":19,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240105/e5d535308ff446a0bc5538aebda2d3c6回力.jpg\",\"name\":\"回力\",\"updateTime\":\"2024-01-04 17:24:58\"},{\"createTime\":\"2023-12-31 04:45:43\",\"id\":15,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/66a271d29a4d40f99448bd854530c662公牛.jpg\",\"name\":\"公牛\",\"updateTime\":\"2023-12-31 04:45:43\"},{\"createTime\":\"2023-12-31 04:36:21\",\"id\":12,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/7fe6a87ae50d4ecea4f52db30ce8e18b完美日记.jpg\",\"name\":\"完美日记\",\"updateTime\":\"2023-12-31 04:36:21\"},{\"createTime\":\"2023-12-31 04:36:02\",\"id\":11,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20240103/6879f475d1c24ae68bd874a06d9a5aa7南极人.jpg\",\"name\":\"南极人\",\"updateTime\":\"2023-12-31 04:36:02\"},{\"createTime\":\"2023-12-28 03:22:52\",\"id\":7,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/c8fb6ef3647b464fa7e740e5b0ecdeb307.jpg\",\"name\":\"特步\",\"updateTime\":\"2023-12-28 03:22:52\"},{\"createTime\":\"2023-12-28 02:58:24\",\"id\":6,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/db8b5c991f1e43289dab18dc0322069c香奈儿.jpg\",\"name\":\"香奈儿\",\"updateTime\":\"2023-12-28 02:58:24\"},{\"createTime\":\"2023-12-28 02:46:22\",\"id\":5,\"isDeleted\":0,\"logo\":\"http://127.0.0.1:9000/go-mall/20231228/a1450920b1934e0ba486e4cd70282153uniqlo.png\",\"name\":\"优衣库\",\"updateTime\":\"2023-12-28 04:04:37\"},{\"createTime\":\"2023-05-06 09:31:19\",\"id\":2,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/华为.png\",\"name\":\"华为\",\"updateTime\":\"2023-05-06 09:31:19\"},{\"createTime\":\"2023-05-06 09:30:27\",\"id\":1,\"isDeleted\":0,\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"name\":\"小米\",\"updateTime\":\"2023-06-02 09:40:24\"}],\"navigateFirstPage\":1,\"navigateLastPage\":1,\"navigatePages\":8,\"navigatepageNums\":[1],\"nextPage\":0,\"pageNum\":1,\"pageSize\":10,\"pages\":1,\"prePage\":0,\"size\":10,\"startRow\":1,\"total\":10},\"message\":\"操作成功\"}', '0', null, '2024-01-04 22:03:36', null, '0');
...
INSERT INTO `sys_role` VALUES ('41', '客服人员', 'kfry', null, '2023-12-29 06:06:46', '2023-12-29 06:07:07', '0');
INSERT INTO `sys_role` VALUES ('42', 'test666', 'test666', null, '2023-12-29 06:09:14', '2023-12-29 06:09:50', '1');
INSERT INTO `sys_role` VALUES ('43', '11111', '11111', null, '2023-12-29 06:10:06', '2024-01-04 15:19:40', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb3 COMMENT='角色菜单';
...
INSERT INTO `sys_role_menu` VALUES ('145', '9', '1', '2023-12-27 07:29:35', '2024-01-04 17:22:45', '0', '1');
...
INSERT INTO `sys_role_menu` VALUES ('167', '10', '1', '2023-12-27 07:29:44', '2024-01-04 17:22:45', '0', '1');
...
INSERT INTO `sys_role_menu` VALUES ('207', '36', '8', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('208', '36', '9', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('209', '36', '10', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('210', '36', '11', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('211', '36', '12', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('212', '36', '13', '2023-12-31 05:56:05', '2023-12-31 05:56:05', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('213', '43', '2', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('214', '43', '7', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('215', '43', '9', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('216', '43', '1', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '1');
INSERT INTO `sys_role_menu` VALUES ('217', '43', '5', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '1');
INSERT INTO `sys_role_menu` VALUES ('218', '43', '8', '2024-01-04 15:19:33', '2024-01-04 15:19:33', '0', '1');
INSERT INTO `sys_role_menu` VALUES ('219', '41', '1', '2024-01-04 17:22:10', '2024-01-04 17:22:45', '0', '1');
INSERT INTO `sys_role_menu` VALUES ('220', '41', '2', '2024-01-04 17:22:10', '2024-01-04 17:22:10', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('221', '41', '3', '2024-01-04 17:22:10', '2024-01-04 17:22:10', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('222', '41', '4', '2024-01-04 17:22:10', '2024-01-04 17:22:10', '0', '0');
INSERT INTO `sys_role_menu` VALUES ('223', '41', '21', '2024-01-04 17:22:10', '2024-01-04 17:22:10', '0', '0');
...
INSERT INTO `sys_user` VALUES ('18', 'marry', '96e79218965eb72c92a549dd5a330112', '迈瑞', '123456763', 'http://127.0.0.1:9000/go-mall/20240103/380c27f5bf97420d91cb5383a74da1d095.jpg', '我是迈瑞', '1', '2023-12-31 03:48:26', '2023-12-31 03:49:27', '1');
INSERT INTO `sys_user` VALUES ('19', 'marry', '96e79218965eb72c92a549dd5a330112', '迈瑞', '643252314', 'http://127.0.0.1:9000/go-mall/20240103/ab7320c2fb4c488ea135b97f1b87ed4301.jpg', '我是迈瑞', '1', '2023-12-31 03:50:06', '2023-12-31 04:03:27', '0');
INSERT INTO `sys_user` VALUES ('20', 'mikea', '96e79218965eb72c92a549dd5a330112', '麦克', '5255422643', 'http://127.0.0.1:9000/go-mall/20240103/9ba230bf97e24f059b404190cd76f6b997.jpg', '我是mikea', '1', '2023-12-31 05:29:45', '2024-01-04 15:18:58', '1');
INSERT INTO `sys_user` VALUES ('21', '111', '96e79218965eb72c92a549dd5a330112', '111111', '1112341', 'http://127.0.0.1:9000/go-mall/20240103/1d022d3acd654873a9343c273f0ff82797.jpg', '1234', '1', '2023-12-31 05:43:16', '2023-12-31 05:43:21', '1');
INSERT INTO `sys_user` VALUES ('22', '222', '96e79218965eb72c92a549dd5a330112', '2222', '22222', 'http://127.0.0.1:9000/go-mall/20240105/55072dcf8f644301947790ad69b752842-1.jpg', '2222', '1', '2024-01-04 17:21:23', '2024-01-04 17:21:34', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb3 COMMENT='用户角色';
...
INSERT INTO `sys_user_role` VALUES ('26', '36', '19', '2023-12-31 03:50:42', '2023-12-31 03:50:42', '0');
INSERT INTO `sys_user_role` VALUES ('29', '36', '14', '2023-12-31 05:55:52', '2023-12-31 05:55:52', '0');
INSERT INTO `sys_user_role` VALUES ('30', '37', '17', '2024-01-04 17:21:46', '2024-01-04 17:21:46', '0');
INSERT INTO `sys_user_role` VALUES ('31', '9', '17', '2024-01-04 17:21:46', '2024-01-04 17:21:46', '0');
...
-- ----------------------------
INSERT INTO `user_address` VALUES ('1', '34', 'Lee', '15937346839', '公司', '110000', '110100', '110114', '天通苑大街1号', '北京市北京市昌平区', '0', '2023-05-12 09:50:41', '2024-01-04 13:58:12', '0');
...
INSERT INTO `user_address` VALUES ('4', '34', 'leee', '15937346839', '学校', '410000', '410700', '410702', '河南师范大学', '河南省新乡市红旗区', '1', '2024-01-04 13:56:49', '2024-01-04 13:57:20', '0');
INSERT INTO `user_address` VALUES ('5', '36', 'kris', '15937346839', '学校', '410000', '410700', '410702', '河南师范大学平原湖校区', '河南省新乡市红旗区', '1', '2024-01-04 17:34:41', '2024-01-04 17:34:41', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户浏览记录表';
...
INSERT INTO `user_browse_history` VALUES ('10', '34', '22', '2024-01-04 13:59:36', '2024-01-04 13:59:36', '0');
INSERT INTO `user_browse_history` VALUES ('11', '34', '24', '2024-01-04 13:59:44', '2024-01-04 13:59:44', '0');
INSERT INTO `user_browse_history` VALUES ('12', '34', '31', '2024-01-04 14:00:00', '2024-01-04 14:00:00', '0');
INSERT INTO `user_browse_history` VALUES ('13', '36', '28', '2024-01-04 17:33:45', '2024-01-04 17:33:46', '0');
INSERT INTO `user_browse_history` VALUES ('14', '36', '2', '2024-01-04 17:35:29', '2024-01-04 17:35:29', '0');
INSERT INTO `user_browse_history` VALUES ('15', '36', '21', '2024-01-04 17:35:32', '2024-01-04 17:35:32', '0');
...
CREATE TABLE `user_collect` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户收藏表';
...
INSERT INTO `user_collect` VALUES ('4', '34', '22', '2024-01-04 10:07:33', '2024-01-04 10:07:33', '0');
INSERT INTO `user_collect` VALUES ('5', '34', '19', '2024-01-04 10:07:37', '2024-01-04 10:07:37', '0');
INSERT INTO `user_collect` VALUES ('6', '34', '16', '2024-01-04 10:07:41', '2024-01-04 10:07:41', '0');
INSERT INTO `user_collect` VALUES ('7', '34', '9', '2024-01-04 10:07:45', '2024-01-04 10:07:45', '0');
INSERT INTO `user_collect` VALUES ('8', '34', '2', '2024-01-05 01:21:41', '2024-01-05 01:21:41', '0');
INSERT INTO `user_collect` VALUES ('9', '34', '22', '2024-01-05 07:03:20', '2024-01-05 07:03:20', '0');
INSERT INTO `user_collect` VALUES ('10', '34', '24', '2024-01-05 07:03:27', '2024-01-05 07:03:27', '0');
INSERT INTO `user_collect` VALUES ('11', '34', '31', '2024-01-05 07:03:42', '2024-01-05 07:03:42', '0');
INSERT INTO `user_collect` VALUES ('12', '34', '24', '2024-01-05 07:14:07', '2024-01-05 07:14:07', '0');
INSERT INTO `user_collect` VALUES ('13', '34', '24', '2024-01-05 07:22:08', '2024-01-05 07:22:08', '0');
INSERT INTO `user_collect` VALUES ('14', '34', '1', '2024-01-05 07:45:17', '2024-01-05 07:45:17', '0');
INSERT INTO `user_collect` VALUES ('15', '34', '2', '2024-01-05 07:45:20', '2024-01-05 07:45:20', '0');
INSERT INTO `user_collect` VALUES ('16', '34', '1', '2024-01-05 07:45:23', '2024-01-05 07:45:23', '0');
INSERT INTO `user_collect` VALUES ('17', '34', '20', '2024-01-05 07:49:54', '2024-01-05 07:49:54', '0');
INSERT INTO `user_collect` VALUES ('18', '34', '20', '2024-01-05 07:52:27', '2024-01-05 07:52:27', '0');
INSERT INTO `user_collect` VALUES ('19', '34', '20', '2024-01-05 07:54:37', '2024-01-05 07:54:37', '0');
INSERT INTO `user_collect` VALUES ('20', '34', '20', '2024-01-05 07:54:41', '2024-01-05 07:54:41', '0');
INSERT INTO `user_collect` VALUES ('21', '34', '24', '2024-01-05 11:48:42', '2024-01-05 11:48:42', '0');
INSERT INTO `user_collect` VALUES ('22', '34', '24', '2024-01-05 11:52:46', '2024-01-05 11:52:46', '0');
INSERT INTO `user_collect` VALUES ('23', '34', '23', '2024-01-05 11:55:26', '2024-01-05 11:55:26', '0');
INSERT INTO `user_collect` VALUES ('24', '34', '23', '2024-01-05 12:03:08', '2024-01-05 12:03:08', '0');
INSERT INTO `user_collect` VALUES ('25', '34', '20', '2024-01-05 12:16:12', '2024-01-05 12:16:12', '0');
INSERT INTO `user_collect` VALUES ('26', '34', '21', '2024-01-05 12:33:37', '2024-01-05 12:33:37', '0');
INSERT INTO `user_collect` VALUES ('27', '36', '29', '2024-01-05 12:52:06', '2024-01-05 12:52:06', '0');
INSERT INTO `user_collect` VALUES ('28', '36', '28', '2024-01-05 12:53:05', '2024-01-05 12:53:05', '0');
INSERT INTO `user_collect` VALUES ('29', '36', '2', '2024-01-05 12:54:43', '2024-01-05 12:54:43', '0');
INSERT INTO `user_collect` VALUES ('30', '36', '21', '2024-01-05 12:54:47', '2024-01-05 12:54:47', '0');
INSERT INTO `user_collect` VALUES ('31', '36', '33', '2024-01-05 12:54:50', '2024-01-05 12:54:50', '0');
INSERT INTO `user_collect` VALUES ('32', '36', '21', '2024-01-07 08:39:45', '2024-01-07 08:39:45', '0');
INSERT INTO `user_collect` VALUES ('33', '36', '22', '2024-01-07 08:39:53', '2024-01-07 08:39:53', '0');
INSERT INTO `user_collect` VALUES ('34', '36', '15', '2024-01-07 08:40:03', '2024-01-07 08:40:03', '0');
INSERT INTO `user_collect` VALUES ('35', '36', '18', '2024-01-07 08:41:50', '2024-01-07 08:41:50', '0');
INSERT INTO `user_collect` VALUES ('36', '36', '13', '2024-01-07 08:41:56', '2024-01-07 08:41:56', '0');
INSERT INTO `user_collect` VALUES ('37', '36', '13', '2024-01-08 00:11:29', '2024-01-08 00:11:29', '0');
INSERT INTO `user_collect` VALUES ('38', '36', '28', '2024-01-08 00:19:38', '2024-01-08 00:19:38', '0');
INSERT INTO `user_collect` VALUES ('39', '36', '28', '2024-01-08 00:19:39', '2024-01-08 00:19:39', '0');
INSERT INTO `user_collect` VALUES ('40', '36', '32', '2024-01-08 01:21:01', '2024-01-08 01:21:01', '0');
INSERT INTO `user_collect` VALUES ('41', '36', '32', '2024-01-08 01:21:09', '2024-01-08 01:21:09', '0');
INSERT INTO `user_collect` VALUES ('42', '36', '32', '2024-01-08 01:32:19', '2024-01-08 01:32:19', '0');
INSERT INTO `user_collect` VALUES ('43', '36', '32', '2024-01-08 01:32:47', '2024-01-08 01:32:47', '0');
INSERT INTO `user_collect` VALUES ('44', '36', '31', '2024-01-08 01:32:55', '2024-01-08 01:32:55', '0');
INSERT INTO `user_collect` VALUES ('45', '36', '31', '2024-01-08 01:57:43', '2024-01-08 01:57:43', '0');
INSERT INTO `user_collect` VALUES ('46', '36', '31', '2024-01-08 01:58:09', '2024-01-08 01:58:09', '0');
INSERT INTO `user_collect` VALUES ('47', '36', '21', '2024-01-08 02:45:15', '2024-01-08 02:45:15', '0');
INSERT INTO `user_collect` VALUES ('48', '36', '34', '2024-01-08 02:46:07', '2024-01-08 02:46:07', '0');
INSERT INTO `user_collect` VALUES ('49', '36', '31', '2024-01-08 03:00:29', '2024-01-08 03:00:29', '0');
INSERT INTO `user_collect` VALUES ('50', '36', '35', '2024-01-08 03:00:33', '2024-01-08 03:00:33', '0');
INSERT INTO `user_collect` VALUES ('51', '36', '35', '2024-01-08 03:00:37', '2024-01-08 03:00:37', '0');
INSERT INTO `user_collect` VALUES ('52', '36', '13', '2024-01-08 03:00:39', '2024-01-08 03:00:39', '0');
INSERT INTO `user_collect` VALUES ('53', '36', '6', '2024-01-08 03:00:43', '2024-01-08 03:00:43', '0');
INSERT INTO `user_collect` VALUES ('54', '36', '32', '2024-01-08 03:01:21', '2024-01-08 03:01:21', '0');
INSERT INTO `user_collect` VALUES ('55', '36', '34', '2024-01-08 03:01:24', '2024-01-08 03:01:24', '0');
INSERT INTO `user_collect` VALUES ('56', '36', '31', '2024-01-08 03:01:28', '2024-01-08 03:01:28', '0');
INSERT INTO `user_collect` VALUES ('57', '36', '13', '2024-01-08 03:01:32', '2024-01-08 03:01:32', '0');
INSERT INTO `user_collect` VALUES ('58', '36', '33', '2024-01-08 03:01:42', '2024-01-08 03:01:42', '0');
INSERT INTO `user_collect` VALUES ('59', '36', '24', '2024-01-08 03:01:48', '2024-01-08 03:01:48', '0');
INSERT INTO `user_collect` VALUES ('60', '36', '27', '2024-01-08 03:01:52', '2024-01-08 03:01:52', '0');
INSERT INTO `user_collect` VALUES ('61', '36', '31', '2024-01-08 03:02:05', '2024-01-08 03:02:05', '0');
INSERT INTO `user_collect` VALUES ('62', '36', '1', '2024-01-08 03:24:30', '2024-01-08 03:24:30', '0');
...
CREATE TABLE `user_info` (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员表';
...
INSERT INTO `user_info` VALUES ('34', '15937346839', '96e79218965eb72c92a549dd5a330112', 'lee', '15937346839', 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', '0', null, null, null, null, null, '1', '2023-12-30 06:53:12', '2023-12-30 06:53:12', '0');
INSERT INTO `user_info` VALUES ('35', '15138644916', '96e79218965eb72c92a549dd5a330112', 'zhang', '15138644916', 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', '0', null, null, null, null, null, '1', '2023-12-31 13:36:15', '2023-12-31 13:36:15', '0');
INSERT INTO `user_info` VALUES ('36', '15037664086', '96e79218965eb72c92a549dd5a330112', 'kris', '15037664086', 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', '0', null, null, null, null, null, '1', '2024-01-04 17:32:17', '2024-01-04 17:32:17', '0');
