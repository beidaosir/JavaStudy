...
public class FoodViewImpl implements FoodView {
    ...
    public void listFoodByBusinessId(Integer businessId) {
        ...
        if (foods==null || foods.size()==0){
            System.out.println("贵餐品尚未添加餐品，请添加之后再查询");
            return;
        }

        System.out.println("餐品编号\t餐品名称\t餐品介绍\t餐品价格");
        for (Food food:foods) {
    ...
    public void saveFood(Integer businessId) {
        ...
        Food food = new Food();
        food.setBusinessId(businessId); //设置商家编号
    ...
    public void updateFood(Integer businessId) {
        ...
        System.out.println("您要修改餐品简介吗？(y/n)");
        inputStr = scanner.next();
        if ("y".equals(inputStr)){
            System.out.println("请输入新的餐品简介：");
    ...
    public void removeFood(Integer businessId) {
        ...
        if ("y".equals(inputStr)){
            //可以删除了
            boolean b = foodDao.removeFood(foodId);
