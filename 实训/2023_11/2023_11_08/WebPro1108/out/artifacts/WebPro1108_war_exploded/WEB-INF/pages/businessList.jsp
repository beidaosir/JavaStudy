<%@ page import="cn.elem.vo.PageBean" %>
<%@ page import="cn.elem.bean.Business" %>
    ...
    <table class="table table-hover">
        ...
        %>
            <tr>
                ...
                <td>
                    <a href="/business/findById?bid=<%=business.getBid()%>">修改</a>
                    <a href="/business/del?delId=<%=business.getBid()%>">删除</a>
                </td>
            </tr>
