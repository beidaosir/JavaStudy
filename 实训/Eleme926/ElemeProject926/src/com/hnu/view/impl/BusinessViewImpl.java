...
public class BusinessViewImpl implements BusinessView {
    ...
    public void searchBusiness() {
        ...
        List<Business> businessList = businessService.listBusiness(businessName, businessAddress);
    ...
    public void saveBusiness() {
        ...
        boolean b = businessService.saveBusiness(businessName);
    ...
    public void removeBusiness() {
        ...
        String inputStr = scanner.next();
        if ("y".equals(inputStr)){
            boolean b = businessService.removeBusiness(businessId);
    ...
    public Business login() {
        ...
        return businessService.login(businessId,businessPassword);
    }
    ...
    public void updateBusinessByPassword(Business business) {
        ...
        boolean b = businessService.updateBusinessByPassword(business.getBusinessId(), newPass1);
